...
datagroup: performance_analyze_bigquery_complex_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: performance_analyze_bigquery_complex_default_datagroup
...
explore: store_returns_partitioned {}

explore: store_returns_partitioned_bkp {}
...
explore: store_sales_partitioned {}

explore: store_sales_partitioned_bkp {}
...
explore: web_returns_partitioned {}

explore: web_returns_partitioned_bkp {}
...
explore: web_sales_partitioned {}

explore: web_sales_partitioned_bkp {}
